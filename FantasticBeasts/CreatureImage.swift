...
class CreatureImage {
    //Initializes from custom creatureImagesJSON via CreatureController.
    //creatureImagesJSON is member of creatureImagesJSONCollection, an array of dictionaries.
